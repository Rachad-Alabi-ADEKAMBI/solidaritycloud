<?php
/*
 * Plugin Name:       solidaire
 * Plugin URI:        https://adekambirachad.com
 * Description:       Homepage SolidaireCloud
 * Version:           1.10.3
 * Requires at least: 5.2
 * Requires PHP:      7.2
 * Author:            Rachad ADEKAMBI
 * Author URI:         https://adekambirachad.com
 * License:           GPL v2 or later
 * License URI:       https://www.gnu.org/licenses/gpl-2.0.html
 * Update URI:        https://example.com/my-plugin/
 * Text Domain:       solidairecloud
 * Domain Path:       /languages
 */

function displaySolidaire()
{
    $image_url1 = esc_url(
        plugin_dir_url(__FILE__) . 'img/alex-knight-2EJCSULRwC8-unsplash.jpg'
    );
    $image_url2 = esc_url(
        ...
        <div class='container about' id='about'>
            ...
            <div class='row about__content '>
                <div class='col-sm-12 col-md-6 text-center about__content__image '>
                 <img class='mt-2' src='$image_url1' alt=''>
                </div>
            ...
            <section class='section bg-light mt-4'>
                <div class='container about' id='about'>
                    ...
                    <div class='row about__content '>
                        ...
                        <div class='col-sm-12 col-md-6 about__content__image'>
                        <img class='mt-2' src='$image_url2' alt=''>
                        </div>
                    </div>
                </div>
            </section>
    ...
    wp_enqueue_script(
        'app',
        esc_url(plugin_dir_url(__FILE__) . 'app.js'),
        ['vue'],
        null,
        true
    );
...
add_shortcode('solidaire', 'displaySolidaire');
